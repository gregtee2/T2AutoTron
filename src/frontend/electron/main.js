...
const crashDir = path.join(__dirname, '..', '..', '..', 'crashes'); // Points to C:\X_T2_AutoTron2.0\crashes
...
function createWindow() {
    ...
    mainWindow.loadFile(path.join(__dirname, '..', 'index.html')); // Points to src/frontend/index.html
...
ipcMain.on('save-api-keys', (event, keys) => {
    const envPath = path.join(__dirname, '..', '..', '..', '.env'); // Points to C:\X_T2_AutoTron2.0\.env
    try {
