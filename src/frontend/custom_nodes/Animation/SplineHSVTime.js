if (!LiteGraph.registered_node_types["Animation/SplineHSVTime"]) {
    ...
    class SplineHSVTimeNode extends LiteGraph.LGraphNode {
            ...
            if (this.pendingMouseEvent) {
                ...
                if (
                    ...
                    if (event.button === 0) {
                        ...
                        if (this.properties.debug) console.log("No anchor point or curve segment selected");
                    }
                } else if (this.properties.debug) {
                    console.log("Mouse down outside editor bounds");
                }
            }
        ...
        onMouseMove(event) {
            if (!this.dragging || !this.selectedPoint || !this.draggingComponent) return;
